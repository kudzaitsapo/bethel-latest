...
@bp.route('/premedication_records/<int:premedication_record_id>', methods=['GET'])
...
@bp.route('/premedication_records', methods=['GET'])
...
@bp.route('/premedication_records', methods=['POST'])
...
@bp.route('/premedication_records/<int:premedication_record_id>', methods=['DELETE'])
def delete_premedication_record_details(premedication_record_id):
    return "delete premedication_record"

@bp.route('/premedication_records/<int:premedication_record_id>', methods=['PATCH'])
