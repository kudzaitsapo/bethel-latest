...
@bp.route('/operative_records/<int:operative_record_id>', methods=['GET'])
...
@bp.route('/operative_records', methods=['GET'])
...
@bp.route('/operative_records', methods=['POST'])
...
@bp.route('/operative_records/<int:operative_record_id>', methods=['DELETE'])
def delete_operative_record_details(operative_record_id):
    return "delete operative_record"

@bp.route('/operative_records/<int:operative_record_id>', methods=['PATCH'])
